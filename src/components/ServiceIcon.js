...
// Set curado de íconos de marca (datos extraídos de Simple Icons), solo para los
// servicios que usa la app hoy. Evita bundlear el catálogo completo (~3300 íconos).
const SERVICE_ICONS = {
  netflix: {
    hex: 'E50914',
